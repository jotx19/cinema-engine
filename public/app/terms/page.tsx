...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of use">
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">What you may do</h2>
      <p>
        ...
        <a className="text-[#111] underline" href="/license">
          License
        </a>
        .
      </p>
      <h2 className="pt-4 text-lg font-medium text-[#111]">What you must not do</h2>
      <p>
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">Audio routing</h2>
      <p>
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">No warranty</h2>
      <p>
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">Third-party software</h2>
      <p>
