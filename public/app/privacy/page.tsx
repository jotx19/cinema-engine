...
export default function PrivacyPage() {
  return (
    <LegalShell title="Privacy">
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">Audio</h2>
      <p>
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">Microphone permission</h2>
      <p>
      ...
      <h2 className="pt-4 text-lg font-medium text-[#111]">Files on disk</h2>
      <p>
        Mix settings and runtime state may be stored under <code>~/.cinema-engine/</code> on your
        machine. We do not collect those files.
      </p>
      <h2 className="pt-4 text-lg font-medium text-[#111]">This website</h2>
      <p>
